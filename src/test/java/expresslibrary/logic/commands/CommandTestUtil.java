...
public class CommandTestUtil {
    ...
    public static final String VALID_BOOK_AMY = "Book 1";
    public static final String VALID_BOOK_BOB = "Book 2";
    ...
    public static final String BOOK_DESC_AMY = " " + PREFIX_ADDRESS + VALID_BOOK_AMY;
    public static final String BOOK_DESC_BOB = " " + PREFIX_ADDRESS + VALID_BOOK_BOB;
